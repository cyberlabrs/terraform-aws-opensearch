...
resource "aws_opensearch_domain" "opensearch" {
  ...
  advanced_security_options {
    ...
    master_user_options {
      ...
      master_user_password = var.master_password == "" && !var.internal_user_database_enabled ? random_password.password.result : var.master_password
    }
  }
  ...
  dynamic "cognito_options" {
    ...
    content {
      ...
      role_arn         = var.implicit_create_cognito == true ? try(aws_iam_role.cognito_es_role[0].arn, "arn:aws:iam::911111111111:role/mockup") : var.cognito_role_arn
    }
  }
  ...
  depends_on = [aws_iam_service_linked_role.es, aws_iam_service_linked_role.es_shared[0], aws_iam_role.cognito_es_role[0]]
}
